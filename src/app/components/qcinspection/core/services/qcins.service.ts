...
export class QcinsService {
  ...
  async GetListQCInspection(headerID: any, fromDate: any, toDate: any): Promise<any> {
    const params = {
      headerID: headerID,
      fromDate : fromDate,
      toDate : toDate
  ...
  async GetWODocNoListByLine(id: any): Promise<any> {
    const params = {
      id : id
    };
    const res = await this.apiService.get(this.urlSegement.GetWODocNoListByLine);
    return res;
  }
  ...
  async GetStageExs(id: any): Promise<any> {
    const params = {
      id : id
    };
    const res = await this.apiService.get(this.urlSegement.GetStageExs);
    return res;
  }
