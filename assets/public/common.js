...
/* harmony export */ });
/* harmony import */ var d_Airspeed_Dev_ASP_Mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator */ 62783);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,d_Airspeed_Dev_ASP_Mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,d_Airspeed_Dev_ASP_Mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,d_Airspeed_Dev_ASP_Mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CustomerFilterModalComponent": () => (/* reexport safe */ _customer_filter_modal_component__WEBPACK_IMPORTED_MODULE_0__.CustomerFilterModalComponent),
/* harmony export */   "ProductFilterModalComponent": () => (/* reexport safe */ _product_filter_modal_component__WEBPACK_IMPORTED_MODULE_1__.ProductFilterModalComponent)
/* harmony export */ });
/* harmony import */ var _customer_filter_modal_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./customer-filter-modal.component */ 44411);
...
/***/ 17866:
/*!************************************************************************!*\
  !*** ./src/app/components/report-info/core/services/report.service.ts ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let ReportService = class ReportService {
    ...
    GetReport(Report_Id, Software_Id) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            const params = {
                Report_Id: Report_Id,
                Software_Id: Software_Id,
            };
            const res = yield this.apiService.get(this.urlSegement.GetReport, params);
            return res;
        });
    }
    GetMobileReport(Software_Id) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            const params = {
                Software_Id: Software_Id,
            };
            const res = yield this.apiService.get(this.urlSegement.GetMobileReport, params);
            return res;
        });
    }
    GetColumnReport(Report_Id) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            ...
            const res = yield this.apiService.get(this.urlSegement.GetColumnReport, params);
            return res;
        });
    }
    GetData(Item = {}) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            ...
            const res = yield this.apiService.post(this.urlSegement.GetData, params);
            return res;
        });
    }
};
...
/***/ 81682:
/*!****************************************************!*\
  !*** ./src/app/components/warehouse/core/index.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WarehousesService": () => (/* reexport safe */ _services__WEBPACK_IMPORTED_MODULE_0__.WarehousesService)
/* harmony export */ });
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services */ 60185);
...
/***/ 60185:
/*!*************************************************************!*\
  !*** ./src/app/components/warehouse/core/services/index.ts ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WarehousesService": () => (/* reexport safe */ _warehouses_service__WEBPACK_IMPORTED_MODULE_0__.WarehousesService)
/* harmony export */ });
/* harmony import */ var _warehouses_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./warehouses.service */ 85581);
...
/***/ 85581:
/*!**************************************************************************!*\
  !*** ./src/app/components/warehouse/core/services/warehouses.service.ts ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WarehousesService": () => (/* binding */ WarehousesService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 39859);
...
let WarehousesService = class WarehousesService {
    ...
    GetListForvoucher(filterParams) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            const body = {
                filterParams: filterParams
            };
            const res = yield this.apiService.post(this.urlSegement.GetListForvoucher, body);
            return res;
        });
    }
    getDmVt(filterParams) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            const body = {
                filterParams: filterParams
            };
            const res = yield this.apiService.post(this.urlSegement.GetDmVt, body);
            return res;
        });
    }
    getDmVtDetail(filterParams) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            const body = {
                filterParams: filterParams
            };
            const res = yield this.apiService.post(this.urlSegement.GetDmVtDetail, body);
            return res;
        });
    }
    getDmKho(filterParams) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            const body = {
                filterParams: filterParams
            };
            const res = yield this.apiService.post(this.urlSegement.GetDmKho, body);
            return res;
        });
    }
    getDmKhoDetail(filterParams) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            const body = {
                filterParams: filterParams
            };
            const res = yield this.apiService.post(this.urlSegement.GetDmKhoDetail, body);
            return res;
        });
    }
    Save_KiemKe(filterParams, lstCt) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            const body = {
                filterParams: filterParams,
                lstCt: lstCt
            };
            const res = yield this.apiService.post(this.urlSegement.Save_KiemKe, body);
            return res;
        });
    }
    save(voucher, enuEdit) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            const body = {
                voucher: voucher,
                enuEdit: enuEdit,
            };
            const res = yield this.apiService.post(this.urlSegement.Save, body);
            return res;
        });
    }
    saveVoucher_Inventory(voucher, enuEdit) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            const body = {
                voucher: voucher,
                enuEdit: enuEdit,
            };
            const res = yield this.apiService.post(this.urlSegement.SaveVoucher_Inventory, body);
            return res;
        });
    }
...
WarehousesService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/***/ 5543:
/*!****************************************!*\
  !*** ./src/app/models/errors.model.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Errors": () => (/* reexport safe */ _errors_model__WEBPACK_IMPORTED_MODULE_0__.Errors),
/* harmony export */   "EntryModel": () => (/* reexport safe */ _report_filter_model__WEBPACK_IMPORTED_MODULE_1__.EntryModel),
/* harmony export */   "LayoutReport": () => (/* reexport safe */ _report_filter_model__WEBPACK_IMPORTED_MODULE_1__.LayoutReport),
/* harmony export */   "ReportFilter": () => (/* reexport safe */ _report_filter_model__WEBPACK_IMPORTED_MODULE_1__.ReportFilter),
/* harmony export */   "SourceModel": () => (/* reexport safe */ _report_filter_model__WEBPACK_IMPORTED_MODULE_1__.SourceModel),
/* harmony export */   "StatusModel": () => (/* reexport safe */ _report_filter_model__WEBPACK_IMPORTED_MODULE_1__.StatusModel)
/* harmony export */ });
/* harmony import */ var _errors_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./errors.model */ 5543);
/* harmony import */ var _report_filter_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./report-filter.model */ 38017);
...
/***/ 38017:
/*!***********************************************!*\
  !*** ./src/app/models/report-filter.model.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ReportFilter": () => (/* binding */ ReportFilter),
/* harmony export */   "LayoutReport": () => (/* binding */ LayoutReport),
/* harmony export */   "EntryModel": () => (/* binding */ EntryModel),
/* harmony export */   "SourceModel": () => (/* binding */ SourceModel),
...
class LayoutReport {
    constructor() {
        ...
        this.kieu_th = false;
        this.so_Ct_SO = false;
        this.so_Ct_KHSX = false;
        this.so_Ct_LSX = false;
...
/***/ 82399:
/*!***********************************!*\
  !*** ./src/app/models/voucher.ts ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VoucherInfo": () => (/* binding */ VoucherInfo),
/* harmony export */   "VoucherHelperService": () => (/* binding */ VoucherHelperService)
/* harmony export */ });
...
class VoucherInfo {
    constructor(_header, _detail) {
        this._headerDefaultValue = {
            ngay_Ct: moment__WEBPACK_IMPORTED_MODULE_1__().format("YYYY-MM-DD"),
            tTien_Hang: 0,
            tTien4: 0,
            chiet_Khau: 0,
            tTien_PhuPhi: 0,
        ...
        this.header = _header !== null && _header !== void 0 ? _header : this._headerDefaultValue;
        this.detail = _detail !== null && _detail !== void 0 ? _detail : [];
    }
}
let VoucherHelperService = class VoucherHelperService {
    constructor() { }
    sum_TTienHang(model) {
        const po = lodash__WEBPACK_IMPORTED_MODULE_0__.filter(model === null || model === void 0 ? void 0 : model.detail, (o) => {
            return !o.is_HangTang;
        }); //Dùng thế này khi cần check thêm (if else) nhiều dk trong hàm return
        model.header = Object.assign(new VoucherInfo(), model === null || model === void 0 ? void 0 : model.header, {
            tTien_Hang: lodash__WEBPACK_IMPORTED_MODULE_0__.sumBy(po, "tien_Nt9"),
        });
    }
    updatePayments(model) {
        var _a, _b, _c;
        model.header = Object.assign(new VoucherInfo(), model === null || model === void 0 ? void 0 : model.header, {
            tTien_ThanhToan: (((_a = model === null || model === void 0 ? void 0 : model.header) === null || _a === void 0 ? void 0 : _a.tTien_Hang) || 0) +
                (((_b = model === null || model === void 0 ? void 0 : model.header) === null || _b === void 0 ? void 0 : _b.tTien3) || 0) -
                (((_c = model === null || model === void 0 ? void 0 : model.header) === null || _c === void 0 ? void 0 : _c.tTien4) || 0),
        });
    }
};
VoucherHelperService.ctorParameters = () => [];
VoucherHelperService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: "root",
    })
